      ...
      <div className="mt-12 grid lg:grid-cols-2 gap-10">
          ...
          <div className="card-premium p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li>
                ...
                <a href={`mailto:${CONTACT.email}`} className="text-navy font-medium hover:text-accent">
                  {CONTACT.email}
                </a>
              </li>
              <li>
        ...
        <form className="card-premium p-6 md:p-8 space-y-5" aria-label="Contact form">
          <div>
            ...
            <input id="contact-name" type="text" required className="w-full rounded-lg border border-border px-4 py-3 text-sm focus:outline focus:outline-2 focus:outline-accent" />
          </div>
          <div>
            <label htmlFor="contact-email" className="block text-sm font-semibold text-navy mb-1">Email *</label>
            <input id="contact-email" type="email" required className="w-full rounded-lg border border-border px-4 py-3 text-sm focus:outline focus:outline-2 focus:outline-accent" />
          </div>
          <div>
            <label htmlFor="contact-message" className="block text-sm font-semibold text-navy mb-1">Message *</label>
            <textarea id="contact-message" rows={5} required className="w-full rounded-lg border border-border px-4 py-3 text-sm focus:outline focus:outline-2 focus:outline-accent" />
          </div>
